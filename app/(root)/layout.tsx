...
export default function HomeLayout({ children }: { children: React.ReactNode }) {
    ...
    // const [autoPlaySpeed, setAutoPlaySpeed] = useState('normal');
    ...
    const autoPlay = async () => {
        ...
        //     let action = 'default';
        //     if (pathname?.includes('/search')) action = 'search';
        //     if (pathname?.includes('/login')) action = 'login';

        //     const baseUrl = process.env.NEXT_PUBLIC_API_BASE_URL;

        //     const response = await fetch(`${baseUrl}/autoplay`, {
        //         method: 'POST',
        //         headers: {
        ...
        //     if (result.success) {
        //         console.log('Autoplay successful:', result.result);
        ...
        //     }
        // } catch (error) {
        //     console.error('Autoplay request error:', error);
        // }
    };
